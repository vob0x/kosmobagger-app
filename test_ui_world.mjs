...
js += `
globalThis.__startAI=function(){ cfg.mode='ai'; game=new Game({modules:2,target:5,deckDoubled:true,boosters:4,tows:2,worldPowers:true,worlds:[['BAU','KOSMOS'],['TECHNIK','TRUCKS']],names:['A','B'],ai:[true,true],aiLevel:0.9}); persp=0; advance(); };
